...
paymentmethod.process_plugin_details = function(json)
{
    ...
    //show show edit vault payment information
    if(json.showeditvaultpaymentinformation){
        ...
        if (document.getElementById('vaultpaymentiframe') !=null) document.getElementById('vaultpaymentiframe').src = "index.php?fuse=admin&view=viewpluginurl&plugintoshow=quantumvault";
    }else{
