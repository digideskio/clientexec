    ...
    try {
        ...
        if (typeof(response.error) != "undefined" && response.error) {
            ...
            if ((response.message != "") && display) {
                error = response.message.replace(/\n/gi, "<br /> \n");
...
clientexec.keen = {};
clientexec.keen.configured_plugin = false;
clientexec.keen.configure = function()
{

    // if (clientexec.keen.configured_plugin) return;
    // Keen.configure({
    //     projectId: clientexec.keen_project,
    //     readKey: clientexec.keen_read,
    //     writeKey: clientexec.keen_write
    // });
    // clientexec.keen.configured_plugin = true;
