...
ticketview.changeassignedpackage = function(e)
{
    ...
    $.ajax({
        ...
        success: function(t) {
            ...
            $('#view-package-link').attr('data-package-id', packageId);
            clientexec.update_ticket_filters();
            ticketview.loadPackageDetails();
        },
        data: {
        ...
        success: function(t) {
            ...
            $.each(t.tabs,
                function(intIndex, objvalue){
                    ...
                    $('#newtab'+intIndex+' span').text(objvalue.ticketTabName);
...
ticketview.submitTicket = function (event, ticketstatus, closed){
    ...
    var url = 'index.php?fuse=support&controller=ticket&action=savenewticketentry';
        ...
        success: function(response) {
            ...
            $.each(response.options,function(index, obj){
                ...
                if (obj.department) {
                    ...
                    $(li).html("<a href='javascript:void(0);' data-id='"+obj.assigneeId+"' onclick='ticketview.changeassignee(this);'><img src='"+ce.getGravatarUrl(obj.email, 20)+"'> <span style='position:relative;top:3px;'>"+obj.assigneeLabel+"</span></a>");
                }
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            if (active_id!=0) {
                ...
                $('#view-package-link').attr('data-package-id', active_package_id);
...
$('#view-package-link').on('click', function(){
    packageId = $(this).attr('data-package-id');
    window.location = 'index.php?fuse=clients&controller=userprofile&view=profileproduct&id=' + packageId;
});
