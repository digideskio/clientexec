$(document).ready(function() {
    ...
    /* TODO: If time permits, implment this:
    $('#profileNotes-grid-filter').change(function(){
        profilenotes.grid.reload({params:{start:0,limit:$(this).val()}});
    });
    */
