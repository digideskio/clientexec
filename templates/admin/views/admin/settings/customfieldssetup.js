function CustomFieldsSetup(options) {
    ...
    this._initializeTree = function () {
        this.dom.divCustomFieldTree.jstree({
            ...
            themes: {
                theme: 'default',
                url:   '../templates/common/js/jquery-jstree/themes/default/style.css',
                dots:  true,
                icons: true
            },
            json_data: {
                ajax: {
                    ...
                    success: function(response) {
                        ...
                        for (var i = 0; i < response.length; i++) {
                            list.push({data: response[i].text, attr: { 'data-id': response[i].id }});
                        }
                        return list;
                    }
                }
            ...
            $.ajax({
                ...
                data: {
                    customfieldid: data.rslt.obj.attr('data-id'),
                    type: that.settings.fieldBelongsTo
                },
                success: function(response) {
    ...
    this._showLoading = function() {
        ...
        this.dom.divLoading.css({
            'background': 'url("../templates/common/img/loading.gif") no-repeat center center',
