    ...
    templates.grid = new RichHTML.grid({
        ...
        columns: [{
            ...
            renderer: function(text, row) {
                ...
                return '<a onclick="templates.window.show({params:{id:'+row.id+'}});" data-toggle="tooltip" data-html="true" title="'+ tooltip + '">' + row.templateName + '</a>';
            },
            flex: 1
        },{
            id: "templateTypeName",
