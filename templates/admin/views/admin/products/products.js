...
$(document).ready(function() {
    ...
    productview.columns = [
        ...
        {
            text: lang("Late Fee"), width: 70, align:'center', dataIndex: 'latefee',
            renderer: function(text,record){
                return productview_priceformatter(text,record,'latefee');
            }
        },
        {
            text: lang("Tax"), width: 30, align:'center',dataIndex: 'taxable',
            renderer: function (text,record) {
        ...
        {
            text: lang("Signup?"), width: 45, align:'center',dataIndex: 'signup',
            renderer: function(text,record){
                if (record.id === 0) return "";
                else if (text === "1") return lang("Yes");
