...
class PluginLivevisitor extends DashboardPlugin
{
    ...
    var $jsLibs  = array('plugins/dashboard/livevisitor/plugin.js','plugins/dashboard/livevisitor/lib/chat.shared.js');
    ...
    public function showadminpanelAction()
    {
        ...
        $this->jsLibs = array("plugins/dashboard/livevisitor/views/adminpanel.js",'templates/common/js/vendor/jquery.ui.widget.js','templates/common/js/jquery.fileupload.js','templates/common/js/bootstrap-file-input.js');
    ...
    public function showchatpopupAction()
    {
        ...
        $this->jsLibs = array("plugins/dashboard/livevisitor/lib/chat.shared.js","plugins/dashboard/livevisitor/chat/chat.js","javascript/hellobar/hellobar.js");
