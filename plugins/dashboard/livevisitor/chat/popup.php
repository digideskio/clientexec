...
<div id="wrapper" class="outline">
	...
	<form id="messageform" action="#" style="display: none;">
		...
		<footer>
			...
			<span id="powered-by"><?php echo $this->user->lang('Powered by') ?> <a href="//www.clientexec.com/?source=chat"><img class="brand-logo" src="templates/common/img/logo_text.png"  style="height: 20px;position: relative;top: 4px;"></a></span>
		</footer>
	</form>
...
<?php echo $this->user->lang('How may we assist you?') ?></label>
		...
		<a href="#" class="button large orange startchattingbtn"><?php echo $this->user->lang('Start Chatting') ?></a>
		<span id="powered-by"><?php echo $this->user->lang('Powered by') ?> <a href="//www.clientexec.com/?source=chat"><img class="brand-logo" src="templates/common/img/logo_text.png" style="height: 20px;position: relative;top: 4px;"></a></span>
	</form>
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
	    	...
	    	$(document).on("click", ".startchattingbtn",function(){
